...
import AnnotationsToggle, { BlockAnnotation } from "./components/AnnotationsToggle";
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f4f1ea] text-[#0d0d0b] font-sans selection:bg-[#0d0d0b]/10 selection:text-[#0d0d0b] overflow-x-hidden pb-12 sm:pb-20">
      ...
      <BlockAnnotation
        ...
        number="①"
        title="Barre d'annonce / Announcement Banner"
        description="Reprendre la barre noire d'AfterAll. Urgent, discret, jamais promotionnel agressif. Message axé sur l'exclusivité de la livraison gratuite au-delà de $200 CAD."
      />
      ...
      <BlockAnnotation
        active={showAnnotations}
        number="②"
        title="Navigation / Menu d'élite"
        description="Logo centré comme AfterAll. Liens de collection minimalistes à gauche, boutons d'action d'ingéniosité (recherche prédictive, panier avec compteur d'état permanent) à droite. Transitions de navigation floutées et translucides au scroll."
      />
      <Navbar 
      ...
      <BlockAnnotation
        active={showAnnotations}
        number="③"
        title="Hero Section / Vision Cinématique"
        description="Plein écran immersif avec l'image maîtresse d'exposition (modèle masculin dans un cadre scandinave épuré). Un titre sous forme de manifeste en police avec empattement massif. Les boutons d'appel à l'achat redirigent directement l'usager vers la grille des produits."
      />
      <section className="relative h-[85vh] sm:h-[90vh] min-h-[600px] w-full flex items-end overflow-hidden bg-[#c8c3b5]">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="/src/assets/images/basta_hero_banner_1779996826682.png"
        ...
        <div className="max-w-7xl mx-auto w-full px-6 sm:px-12 pb-12 sm:pb-20 z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex flex-col items-start md:items-end gap-6 sm:gap-8 md:text-right">
            ...
            <button
              ...
              className="group px-8 py-4 bg-[#f4f1ea] text-[#0d0d0b] text-[0.6rem] sm:text-[0.65rem] font-sans font-light tracking-[0.25em] uppercase hover:bg-[#ede9df] active:scale-98 transition-all flex items-center gap-3 shadow-md"
            >
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2">
          ...
          <div className="w-[1px] h-10 bg-[#ede9df]/20 relative overflow-hidden">
            <span className="absolute top-0 left-0 w-full h-1/2 bg-[#f4f1ea] animate-pulse" style={{ animationDuration: '2s' }} />
          </div>
        </div>
      </section>
      ...
      <BlockAnnotation
        active={showAnnotations}
        number="④"
        title="Ticker de philosophie / Text Carousel"
        description="Un bandeau ticker fluide avec pause automatique au survol du curseur. Remplace le fardeau des slogans promotionnels bon marché par des affirmations d'identité, de composition technologique, et d'esthétique minimaliste."
      />
      <div className="border-y border-[#ccc9c1]/40 bg-[#f4f1ea] py-3.5 overflow-hidden">
        <div className="flex whitespace-nowrap gap-12 w-max animate-infinite-scroll">
          ...
          {[1, 2].map((loopIdx) => (
            <div key={loopIdx} className="flex gap-12 items-center">
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                Silence is luxury <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                Capsule 01 Disponible <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                No logos. No noise. <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                80% Cotton &middot; 20% Lin &middot; 300GSM <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                Confidence doesn't speak <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                Livraison gratuite +$200 CAD <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
              <span className="text-[0.58rem] font-sans uppercase text-[#888580] tracking-[0.22em] flex items-center gap-4">
                Understated. Undeniable. <span className="w-1.5 h-1.5 rounded-full bg-[#ccc9c1] inline-block" />
              </span>
            </div>
          ))}
        </div>
      ...
      <section id="collection" className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24">
        <BlockAnnotation
          active={showAnnotations}
          number="⑤"
          title="Collection de base / Product Catalog Matrix"
          description="Une présentation sous forme de bento-grid épurée. Les images intègrent de subtils contrastes d'ombre naturelle et se zooment magnifiquement au surréalisme lors du survol. Le bouton d'ajout rapide (Quick Add) charge la taille standard 'M' et ouvre le panier instantanément."
        />
        
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div>
            <span className="text-[0.58rem] font-sans tracking-[0.25em] text-[#888580] uppercase block mb-3">
              Garde-robe Sélectionnée
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#0d0d0b] leading-tight">
              The <span className="font-serif italic font-normal text-[#888580]">Essential</span> Wardrobe.
            </h2>
          </div>
          <div>
            <span className="text-[0.62rem] font-sans font-light text-[#2b2b27] uppercase tracking-[0.2em] border-b border-[#ccc9c1] pb-1 cursor-pointer hover:border-[#0d0d0b] transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {PRODUCTS.map((prod) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] w-full bg-[#ede9df] overflow-hidden mb-5">
                <img
                  src={prod.image}
                  alt={prod.name}
                  referrerPolicy="no-referrer"
              ...
              <div className="flex justify-between items-start mt-1">
                <div>
                  ...
                  <p className="text-[0.6rem] font-sans uppercase tracking-[0.15em] text-[#888580] mt-1 flex items-center gap-2">
                    <span 
                      className="w-2.5 h-2.5 rounded-full border border-[#ccc9c1]"
      ...
      <section id="philosophy" className="bg-[#0b0b0a] text-[#f4f1ea] py-16 sm:py-28 relative overflow-hidden">
        <BlockAnnotation
          active={showAnnotations}
          number="⑥"
          title="Manifeste de silence / Brand Philosophy"
          description="Une opposition totale à la frénésie de la mode jetable. Une citation massive en police avec empattement à gauche faisant face à un essai philosophique soigné sur les fondamentaux d'essentialisme masculin à droite."
        />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="border-r border-[#f4f1ea]/10 pr-0 lg:pr-12 md:py-6">
            <span className="text-[0.55rem] font-sans tracking-[0.3em] text-[#888580] uppercase block mb-6">
            ...
            <blockquote className="font-serif text-3xl sm:text-5xl lg:text-6xl font-light leading-[1.08] tracking-tight text-[#f4f1ea]">
              "Silence is the<br />
              highest form of<br />
              <span className="font-serif italic text-[#888580]">presence & power.</span>"
            </blockquote>
          </div>

          {/* Right Block */}
          <div className="space-y-8 lg:pl-4">
            <p className="text-[0.72rem] sm:text-xs font-sans font-light tracking-[0.08em] text-[#ccc9c1] leading-[2.1] max-w-lg">
            ...
            <div className="pt-2 flex items-center gap-6">
              <button
                ...
                className="px-6 py-3 border border-[#f4f1ea]/20 text-[#f4f1ea] text-[0.58rem] font-sans font-light tracking-[0.2em] uppercase hover:bg-[#ede9df]/5 hover:border-[#f4f1ea] transition-all"
              >
      ...
      {/* ============ ⑦ MAIN MATIÈRE (FABRIC) ============ */}
      <section id="fabric" className="bg-[#ede9df] py-16 sm:py-24">
        <BlockAnnotation
          active={activeAccordion !== null && showAnnotations}
          number="⑦"
          title="Focus Matières Premières / Organic Sourcing Grid"
          description="Raconter la fabrication avec rigueur. Un gros plan macro du tissage haut grammage (300GSM), des blocs techniques évaluant la composition naturelle (80% coton de Californie / 20% lin biologique européen), l'élasticité, et le maintien structurel des fibres."
        />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h3 className="font-serif text-3xl sm:text-4xl font-light text-[#0d0d0b] leading-tight">
              ...
              <span className="font-serif italic text-[#888580] font-normal">Structure & Souffle.</span>
            </h3>
            ...
            {/* Micro-specs grid */}
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-[#ccc9c1]/60">
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#888580] mb-0.5">
                  Composition
                </span>
          ...
          <div className="lg:col-span-7 grid grid-cols-12 gap-4 relative">
            <div className="col-span-8 aspect-[4/5] bg-[#ccc9c1]/40 overflow-hidden shadow-sm relative">
              <img
                src="/src/assets/images/basta_fabric_detail_1779996918283.png"
                alt="Basta luxury macro cotton linen textile weaver"
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover select-none"
              />
              <div className="absolute bottom-4 left-4 bg-[#f4f1ea] px-3.5 py-1 text-[0.52rem] font-sans tracking-widest uppercase font-mono text-[#0d0d0b]">
            ...
            <div className="col-span-4 aspect-[3/4] self-end bg-[#2b2b27] overflow-hidden shadow-md hidden sm:block relative">
              ...
              <img
                src="/src/assets/images/basta_navy_trouser_1779996846955.png"
      ...
      <BlockAnnotation
        active={showAnnotations}
        number="⑦1/2"
        title="Bannière Lookbook & Texture Cinématique / Interactive Editorial Slides"
        description="Réplique scrupuleusement la texture brute argentique avec un dégradé chaud crépusculaire. Intègre la typographie minimaliste et offre un bouton d'ouverture vers le carrousel plein écran pour contempler les matières."
      />
      <section className="lookbook-cinematic relative h-[65vh] min-h-[480px] w-full flex flex-col items-center justify-center overflow-hidden border-y border-[#ccc9c1]/20">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('/src/assets/images/basta_hero_banner_1779996826682.png')`,
          }} 
        />
          ...
          >
            ...
            <div className="flex justify-between items-center w-full max-w-7xl mx-auto">
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="logo-label text-[#7d6e62] mt-0.5 block">LABEL</span>
              </div>
            ...
            <div className="my-auto max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center py-6">
              ...
              <div className="lg:col-span-4 space-y-6 text-left order-2 lg:order-1">
                <span className="text-[0.52rem] font-sans tracking-[0.3em] text-[#73655a] uppercase block">
                ...
                <p className="text-[0.68rem] font-sans font-light text-[#ccc9c1]/80 leading-relaxed max-w-sm">
                  {[
                ...
                <div className="border-t border-white/10 pt-4 space-y-1.5 text-[0.6rem] font-sans uppercase tracking-widest text-[#888580]">
              ...
              <div className="lg:col-span-8 order-1 lg:order-2 flex flex-col items-center justify-center relative">
                ...
                <div className="aspect-[4/3] sm:aspect-[16/10] w-full max-h-[55vh] bg-black/40 overflow-hidden relative border border-white/5 shadow-2xl flex items-center justify-center">
                  ...
                  <img
                    src={[
                      "/src/assets/images/basta_bordeaux_trouser_1779996873619.png",
                      "/src/assets/images/basta_bordeaux_henley_1779997542427.png",
                      "/src/assets/images/basta_navy_trouser_1779996846955.png",
                      "/src/assets/images/basta_cream_henley_1779996901259.png"
                    ][lookbookIndex]}
                  ...
                  <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-md px-3 py-1 text-[0.45rem] font-mono tracking-widest text-[#ccc9c1]/80 rounded-xs">
                ...
                <p className="text-[0.48rem] font-sans uppercase tracking-[0.3em] text-[#ccc9c1]/30 mt-3 text-center sm:hidden">
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-white/5 gap-4">
              <p className="text-[0.55rem] font-sans tracking-widest uppercase text-[#ccc9c1]/40 text-center sm:text-left">
      ...
      <section 
        ...
        className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24 border-t border-[#ccc9c1]/30 scroll-mt-24"
      >
        <BlockAnnotation
          active={showAnnotations}
          number="⑧"
          title="Section Fiche Produit Intégrée / Direct Purchasing Node"
          description="La pierre angulaire de la conversion : l'internaute peut alternativement swapper entre les pantalons Navy/Bordeaux ou le Henley, inspecter les détails par carrousel photo, invoquer le guide de taille, configurer sa taille, et commander en un clic."
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            <span className="text-[0.55rem] font-sans tracking-[0.2em] text-[#888580] uppercase block">
              Explorateur Visual-Hub (Angle {activePhotoIndex + 1}/2)
            </span>
            
            {/* Main Picture box with custom loader preview */}
            <div className="aspect-[3/4] w-full bg-[#ede9df] overflow-hidden rounded-xs relative group/detail">
              <img
            ...
            <div className="grid grid-cols-2 gap-4">
              {selectedProduct.secondaryImages.map((src, idx) => (
                <button
                  ...
                  className={`aspect-[4/3] bg-[#ede9df] overflow-hidden border transition-all ${
                    activePhotoIndex === idx
                      ? "border-[#0d0d0b] scale-[0.98] opacity-100 shadow-sm"
                      : "border-[#ccc9c1]/40 opacity-70 hover:opacity-100"
                  }`}
                >
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <div>
              <span className="text-[0.6rem] font-sans font-medium tracking-[0.25em] text-[#888580] uppercase block mb-2">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-light text-[#0d0d0b] tracking-wide leading-tight">
                {selectedProduct.name} &mdash; <span className="font-serif italic font-normal text-[#888580]">{selectedProduct.variantName}</span>
              </h2>
              ...
              <div className="flex items-center gap-4 mt-4">
                ...
                <span className="px-2.5 py-0.5 border border-[#7d6e62]/20 bg-[#7d6e62]/5 text-[#7d6e62] rounded-xs text-[0.55rem] font-sans font-medium tracking-widest uppercase">
                  Finitudes Limite
                </span>
              </div>
            </div>
            ...
            <div>
              <span className="text-[0.55rem] font-medium tracking-[0.18em] text-[#888580] uppercase block mb-2.5">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 border flex items-center gap-2 text-[0.62rem] font-sans uppercase tracking-widest transition-all ${
                      selectedProduct.id === prod.id
                        ? "border-[#0d0d0b] bg-[#ede9df]"
                        : "border-[#ccc9c1]/40 hover:border-[#0d0d0b]"
                    }`}
                  >
                    <span 
                      className="w-3 h-3 rounded-full border border-[#ccc9c1]"
                      style={{ backgroundColor: prod.variantColorCode }}
                    />
            ...
            <div>
              <div className="flex justify-between items-center mb-2.5">
                <span className="text-[0.55rem] font-medium tracking-[0.18em] text-[#888580] uppercase">
                  Taille / Select Size
                </span>
                ...
                >
                  <Ruler className="w-3.5 h-3.5 text-[#888580]" />
                  ...
                  <button
                    ...
                    className={`w-11 h-11 text-xs border tracking-wider font-sans transition-all flex items-center justify-center ${
                      selectedSize === sz
                        ...
                        : "border-[#ccc9c1] text-[#2b2b27] hover:border-[#0d0d0b] hover:text-[#0d0d0b]"
                    }`}
                  >
                    {sz}
                    {sz === "M" && (
                      <span className="absolute text-[0.38rem] translate-y-3.5 text-[#888580] font-mono leading-none">Std</span>
                    )}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                onClick={() => setSizeGuideOpen(true)}
                className="w-full py-4 border border-[#ccc9c1] text-[#2b2b27] hover:border-[#0d0d0b] hover:text-[#0d0d0b] text-[0.62rem] font-sans font-light tracking-[0.22em] uppercase transition-all"
              >
            ...
            <div className="border-t border-[#ccc9c1]/60 pt-4 space-y-2">
              {/* Composition & Care */}
              <div className="border-b border-[#ccc9c1]/20 pb-2">
                <button
                ...
                >
                  ...
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "comp" ? "rotate-90 text-[#7d6e62]" : "text-[#888580]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "comp" && (
                    <motion.div
                      ...
                      className="overflow-hidden text-[0.72rem] text-[#888580] leading-[1.8] font-sans space-y-1.5 py-1"
                    >
              ...
              <div className="border-b border-[#ccc9c1]/20 pb-2">
                ...
                >
                  ...
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "fit" ? "rotate-90 text-[#7d6e62]" : "text-[#888580]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "fit" && (
                    <motion.div
                      ...
                      animate={{ height: "auto", opacity: 1 }}
                      exit={{ height: 0, opacity: 0 }}
                      className="overflow-hidden text-[0.72rem] text-[#888580] leading-[1.8] font-sans space-y-2 py-1"
                    >
              ...
              <div className="border-b border-[#ccc9c1]/20 pb-2">
                ...
                >
                  ...
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "ship" ? "rotate-90 text-[#7d6e62]" : "text-[#888580]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "ship" && (
                    <motion.div
                      ...
                      animate={{ height: "auto", opacity: 1 }}
                      exit={{ height: 0, opacity: 0 }}
                      className="overflow-hidden text-[0.72rem] text-[#888580] leading-[1.8] font-sans py-1"
                    >
      ...
      <section className="bg-[#2b2b27] border-y border-[#ccc9c1]/10 text-[#f4f1ea]">
        <BlockAnnotation
          active={showAnnotations}
          number="⑨"
          title="Bande de Valeurs de Marque / Philosophy Columns"
          description="Les 4 colonnes signature du minimalisme AfterAll, transposées dans la sobriété luxe de Basta. Chaque pilier déstabilise l'usager grâce à un verbe épuré prônant l'absence totale de fioriture et de logos."
        />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-[#ccc9c1]/10">
          {BRAND_VALUES.map((val) => (
            <div key={val.num} className="p-8 sm:p-12 space-y-4">
              <span className="font-serif text-3xl font-light text-[#888580]/30 select-none block leading-none">
                {val.num}
              </span>
              <h4 className="font-serif italic text-base lg:text-lg text-[#f4f1ea] leading-tight">
                {val.title}
              </h4>
              <p className="text-[0.68rem] font-sans font-light text-[#ccc9c1]/60 leading-[1.85] tracking-wide">
                {val.desc}
              </p>
            </div>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24">
        <BlockAnnotation
          active={showAnnotations}
          number="⑩"
          title="Le club des Hommes Silencieux / User Generated Gallery"
          description="Une galerie d'ambiance UGC pour souligner la prestance et le lifestyle du cercle Basta. Au survol, l'opacité filtre un voile de verre flouté révélant le pseudonyme cryptique du porteur."
        />

        <div className="flex justify-between items-end mb-12">
          <div>
            <span className="text-[0.55rem] font-sans tracking-[0.25em] text-[#888580] uppercase block mb-3">
              Cercle Basta Label
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#0d0d0b] leading-[1.12]">
              The <span className="font-serif italic font-normal text-[#888580]">quiet few.</span>
            </h2>
          </div>
          <div>
            <a 
              href="#instagram-link" 
              className="text-[0.62rem] font-sans uppercase tracking-[0.2em] font-medium text-[#0d0d0b] border-b border-[#0d0d0b] pb-0.5 hover:border-[#888580] hover:text-[#888580] transition-colors"
            >
              @bastalabel
            </a>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {SOCIALS.map((soc) => (
            <div
              key={soc.id}
              className="group relative aspect-square bg-[#ede9df] overflow-hidden rounded-xs cursor-pointer"
            >
      ...
      <section className="bg-[#0b0b0a] text-[#f4f1ea] py-20 sm:py-32 border-t border-[#ccc9c1]/10 text-center relative overflow-hidden">
        <BlockAnnotation
          active={showAnnotations}
          number="⑪"
          title="Section d'Accès Limitée (Newsletter) / Secure Sourcing Registry"
          description="Exit les spams invasifs. Basta propose de s'enregistrer auprès de ses archives de production pour recevoir le code d'accès préférentiel de la Capsule 02. Feedback premium en micro-design à la soumission."
        />

        <div className="max-w-2xl mx-auto px-6 relative z-10">
          <span className="text-[0.52rem] font-sans tracking-[0.35em] text-[#888580] uppercase block mb-4">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-light text-[#f4f1ea] tracking-tight leading-none mb-3">
            Rejoins <span className="font-serif italic font-normal text-[#888580]">les rares.</span>
          </h2>
          <p className="text-[0.68rem] sm:text-xs font-sans font-light tracking-[0.1em] text-[#ccc9c1]/75 leading-relaxed max-w-md mx-auto mb-10 sm:mb-12">
      ...
      <section id="faq" className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16">
        <BlockAnnotation
          active={showAnnotations}
          number="⑫"
          title="Foire Aux Questions Structurante / Editorial Support FAQ"
          description="Évacuer les objections d'achat avec panache. Un agencement asymétrique robuste où les lignes de questions-réponses s'ouvrent avec fluidité."
        />

        {/* Left Col */}
        <div className="lg:col-span-4">
          <span className="text-[0.55rem] font-sans tracking-[0.22em] text-[#888580] uppercase block mb-3">
            Soutien à la décision
          </span>
          <h3 className="font-serif text-3xl sm:text-4xl font-light text-[#0d0d0b] leading-tight">
            Questions<br />
            <span className="font-serif italic font-normal text-[#888580]">fréquentes.</span>
          </h3>
          <p className="text-[0.72rem] text-[#888580] mt-4 leading-relaxed max-w-xs font-light">
            ...
            return (
              <div key={faq.id} className="py-5 first:pt-0 last:pb-0">
                ...
                >
                  ...
                  <span className={`text-[1.2rem] font-light transition-transform duration-300 flex-shrink-0 ${isOpen ? "rotate-45 text-[#7d6e62]" : "text-[#888580]"}`}>
                    +
                  </span>
                </button>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="text-[0.72rem] sm:text-[0.75rem] text-[#888580] leading-[1.9] tracking-wide pt-4 pb-1 select-text">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
      ...
      {/* ============ ⑬ FOOTER ============ */}
      <footer className="bg-[#0b0b0a] text-[#f4f1ea] pt-16 sm:pt-24 pb-12 px-6 sm:px-12 border-t border-[#ccc9c1]/10">
        <BlockAnnotation
          active={showAnnotations}
          number="⑬"
          title="Le Pied de Page / The Core Footer"
          description="Quatre colonnes soignées reprenant l'architecture d'AfterAll. Présentation de la licence, des droits de créateur Basta Label, et des réseaux secrets d'identité."
        />
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 sm:gap-8 items-start">
            <div className="lg:col-span-4 space-y-4">
              <div className="flex flex-col items-start select-none">
                ...
                <span className="logo-label text-[#7d6e62] block -mt-0.5">
                  LABEL
                </span>
              </div>
              <p className="text-[0.62rem] text-[#ccc9c1]/50 leading-[1.95] tracking-[0.08em] uppercase max-w-sm">
                Quiet confidence.<br />
            ...
            <div className="lg:col-span-2.5 space-y-4">
              <h4 className="text-[0.55rem] font-sans tracking-[0.25em] text-[#888580] uppercase">
                Acheter / Shop
              </h4>
              <ul className="space-y-2.5 list-none text-[0.65rem] tracking-wider text-[#ccc9c1]/60 font-light uppercase">
                <li>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-10 border-t border-[#ccc9c1]/10 text-[#ccc9c1]/30">
