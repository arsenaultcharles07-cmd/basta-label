        ...
        <div className="fixed inset-0 z-[2000] overflow-hidden">
          ...
          <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
            <motion.div
              ...
              className="w-screen max-w-md bg-[#f4f1ea] border-l border-[#ccc9c1]/60 flex flex-col shadow-2xl text-[#0d0d0b] relative"
            >
              {/* Header */}
              ...
              {checkedOutSuccess ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-[#ede9df]/40">
                  ...
                  <p className="text-[0.65rem] text-[#2b2b27] font-mono mb-8 bg-[#f4f1ea] p-3 px-4 border border-[#ccc9c1]/40 rounded-sm">
                            ...
                            <div key={item.id} className="py-4 first:pt-0 last:pb-0 flex gap-4">
                              ...
                              <div className="flex-1 flex flex-col justify-between">
                                ...
                                <div className="flex justify-between items-center mt-3">
                                  {/* Quantity adjusters */}
                                  <div className="flex items-center border border-[#ccc9c1] rounded-sm bg-[#f4f1ea] px-1">
                                    <button
