...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#8a7b6e] text-[#f4f1ea] font-sans selection:bg-[#0d0d0b]/10 selection:text-[#f4f1ea] overflow-x-hidden pb-12 sm:pb-20">
      ...
      <section className="relative h-[85vh] sm:h-[90vh] min-h-[600px] w-full flex items-end overflow-hidden bg-[#c8c3b5]">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 sm:px-12 pb-12 sm:pb-20 z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex flex-col items-start md:items-end gap-6 sm:gap-8 md:text-right">
            ...
            <button
              ...
              className="group px-8 py-4 bg-[#8a7b6e] text-[#f4f1ea] text-[0.6rem] sm:text-[0.65rem] font-sans font-light tracking-[0.25em] uppercase hover:bg-[#6e6157] active:scale-98 transition-all flex items-center gap-3 shadow-md"
            >
        ...
        <button onClick={() => handleScrollToSection("collection")} className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 group cursor-pointer focus:outline-none" aria-label="Scroll to collection">
          ...
          <div className="w-[1px] h-10 bg-[#f4f1ea]/20 relative overflow-hidden">
            <span className="absolute top-0 left-0 w-full h-1/2 bg-[#f4f1ea]/60 animate-pulse" style={{ animationDuration: '2s' }} />
          </div>
        </button>
      </section>
      <div className="border-y border-[#f4f1ea]/15 bg-[#6e6157] py-3.5 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div>
            <span className="text-[0.58rem] font-sans tracking-[0.25em] text-[#f4f1ea]/50 uppercase block mb-3">
              Garde-robe Sélectionnée
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#f4f1ea] leading-tight">
              The <span className="font-serif italic font-normal text-[#8a7b6e]">Essential</span> Wardrobe.
            </h2>
          </div>
          <div>
            <span className="text-[0.62rem] font-sans font-light text-[#f4f1ea]/80 uppercase tracking-[0.2em] border-b border-[#f4f1ea]/25 pb-1 cursor-pointer hover:border-[#0d0d0b] transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {PRODUCTS.map((prod) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] w-full bg-[#6e6157] overflow-hidden mb-5">
                <img
                  src={prod.image}
                  alt={prod.name}
                  referrerPolicy="no-referrer"
              ...
              <div className="flex justify-between items-start mt-1">
                <div>
                  <h3 className="font-serif text-md font-medium text-[#f4f1ea] tracking-wide">
                    {prod.name}
                  </h3>
                  <p className="text-[0.6rem] font-sans uppercase tracking-[0.15em] text-[#8a7b6e] mt-1 flex items-center gap-2">
                    <span 
                      className="w-2.5 h-2.5 rounded-full border border-[#f4f1ea]/25"
                ...
                <div className="text-right">
                  <span className="text-xs font-sans text-[#f4f1ea] tracking-wider font-medium">
          ...
          <div className="space-y-8 lg:pl-4">
            ...
            <div className="pt-2 flex items-center gap-6">
              <button
                ...
                className="px-6 py-3 border border-[#f4f1ea]/20 text-[#f4f1ea] text-[0.58rem] font-sans font-light tracking-[0.2em] uppercase hover:bg-[#6e6157]/5 hover:border-[#f4f1ea] transition-all"
              >
      ...
      {/* ============ ⑦ MAIN MATIÈRE (FABRIC) ============ */}
      <section id="fabric" className="bg-[#6e6157] py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Text block */}
          <div className="lg:col-span-5 space-y-6">
            <span className="text-[0.55rem] font-sans tracking-[0.22em] text-[#f4f1ea]/80 uppercase block mb-1">
              Origine de Tissage
            </span>
            ...
            <p className="text-[0.72rem] sm:text-xs font-sans font-light text-[#f4f1ea]/80 leading-[2.1] tracking-wide">
            ...
            {/* Micro-specs grid */}
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-[#f4f1ea]/20">
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#8a7b6e] mb-0.5">
                  Composition
                </span>
                <span className="text-xs font-serif italic text-[#f4f1ea]">80% Cotton · 20% Organic Lin</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#8a7b6e] mb-0.5">
                  Densité de Fibre
                </span>
                <span className="text-xs font-sans font-medium text-[#f4f1ea]">300 GSM Heavyweight</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#8a7b6e] mb-0.5">
                  Drap / Tombé
                </span>
                <span className="text-xs font-serif italic text-[#f4f1ea]">Rigide Structuré Flou</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#8a7b6e] mb-0.5">
                  Certifications
                </span>
                <span className="text-xs font-sans font-medium text-[#f4f1ea]">GOTS Bio certifié</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-12 gap-4 relative">
            <div className="col-span-8 aspect-[4/5] bg-[#c4b9aa]/40 overflow-hidden shadow-sm relative">
              ...
              />
              <div className="absolute bottom-4 left-4 bg-[#8a7b6e] px-3.5 py-1 text-[0.52rem] font-sans tracking-widest uppercase font-mono text-[#f4f1ea]">
      ...
      <section 
        ...
        className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24 border-t border-[#f4f1ea]/20 scroll-mt-24"
      >
      {/* Outer Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="aspect-[3/4] w-full bg-[#6e6157] overflow-hidden rounded-xs relative group/detail">
              <img
            ...
            <div className="grid grid-cols-2 gap-4">
              {selectedProduct.secondaryImages.map((src, idx) => (
                <button
                  ...
                  className={`aspect-[4/3] bg-[#6e6157] overflow-hidden border transition-all ${
                    activePhotoIndex === idx
                      ? "border-[#0d0d0b] scale-[0.98] opacity-100 shadow-sm"
                      : "border-[#f4f1ea]/15 opacity-70 hover:opacity-100"
                  }`}
                >
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <div>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-light text-[#f4f1ea] tracking-wide leading-tight">
              ...
              <div className="flex items-center gap-4 mt-4">
                <span className="text-xl font-sans text-[#f4f1ea] font-medium tracking-wide">
                  ${selectedProduct.price.toFixed(2)} CAD
                </span>

                <span className="px-2.5 py-0.5 border border-[#7d6e62]/20 bg-[#6e6157]/5 text-[#8a7b6e] rounded-xs text-[0.55rem] font-sans font-medium tracking-widest uppercase">
                  Finitudes Limite
                </span>
              </div>
            </div>

            <p className="text-[0.72rem] sm:text-xs font-sans font-light text-[#f4f1ea]/80 leading-relaxed">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 border flex items-center gap-2 text-[0.62rem] font-sans uppercase tracking-widest transition-all ${
                      selectedProduct.id === prod.id
                        ? "border-[#0d0d0b] bg-[#6e6157]"
                        : "border-[#f4f1ea]/15 hover:border-[#0d0d0b]"
                    }`}
                  >
                    <span 
                      className="w-3 h-3 rounded-full border border-[#f4f1ea]/25"
                      style={{ backgroundColor: prod.variantColorCode }}
                    />
            ...
            <div>
              <div className="flex justify-between items-center mb-2.5">
                ...
                <button
                  ...
                  className="text-[0.55rem] font-sans font-light tracking-[0.15em] text-[#f4f1ea]/80 uppercase underline hover:opacity-75 flex items-center gap-1.5"
                >
                  ...
                  <button
                    ...
                    className={`w-11 h-11 text-xs border tracking-wider font-sans transition-all flex items-center justify-center ${
                      selectedSize === sz
                        ...
                        : "border-[#f4f1ea]/25 text-[#f4f1ea]/80 hover:border-[#0d0d0b] hover:text-[#f4f1ea]"
                    }`}
                  >
                    {sz}
                    {sz === "M" && (
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                onClick={() => setSizeGuideOpen(true)}
                className="w-full py-4 border border-[#f4f1ea]/25 text-[#f4f1ea]/80 hover:border-[#0d0d0b] hover:text-[#f4f1ea] text-[0.62rem] font-sans font-light tracking-[0.22em] uppercase transition-all"
              >
            ...
            <div className="border-t border-[#f4f1ea]/20 pt-4 space-y-2">
              {/* Composition & Care */}
              <div className="border-b border-[#f4f1ea]/25/20 pb-2">
                <button
                  onClick={() => setActiveAccordion(activeAccordion === "comp" ? null : "comp")}
                  className="w-full flex justify-between items-center py-2 text-xs font-sans font-medium text-[#f4f1ea] tracking-wider uppercase"
                >
                ...
                <AnimatePresence initial={false}>
                  {activeAccordion === "fit" && (
                    ...
                    >
                      ...
                      <p className="pt-2 text-[0.68rem] italic text-[#f4f1ea]/80">Coupe: {selectedProduct.fabricSpecs.fit}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
      ...
      <section className="bg-[#2b2b27] border-y border-[#f4f1ea]/10 text-[#f4f1ea]">
      ...
      <div className="flex justify-between items-end mb-12">
          <div>
            <span className="text-[0.55rem] font-sans tracking-[0.25em] text-[#f4f1ea]/50 uppercase block mb-3">
              Cercle Basta Label
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#f4f1ea] leading-[1.12]">
          ...
          <div>
            <a 
              href="#instagram-link" 
              className="text-[0.62rem] font-sans uppercase tracking-[0.2em] font-medium text-[#f4f1ea] border-b border-[#0d0d0b] pb-0.5 hover:border-[#888580] hover:text-[#8a7b6e] transition-colors"
            >
              @bastalabel
            </a>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {SOCIALS.map((soc) => (
            <div
              key={soc.id}
              className="group relative aspect-square bg-[#6e6157] overflow-hidden rounded-xs cursor-pointer"
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span className="font-serif italic text-3xl opacity-[0.06] text-[#f4f1ea] tracking-widest select-none">Basta.</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-[#0b0b0a] text-[#f4f1ea] py-20 sm:py-32 border-t border-[#f4f1ea]/10 text-center relative overflow-hidden">
      ...
      {/* Left Col */}
        <div className="lg:col-span-4">
          <span className="text-[0.55rem] font-sans tracking-[0.22em] text-[#f4f1ea]/50 uppercase block mb-3">
          ...
          <p className="text-[0.72rem] text-[#8a7b6e] mt-4 leading-relaxed max-w-xs font-light">
            Une hésitation relative à la matière de coton-lin ou au drapé du pantalon ? Nos équipes de couturiers sont rattachées en continu via <span className="font-medium underline hover:text-[#f4f1ea] cursor-pointer">hello@bastalabel.com</span>
          </p>
        </div>
          ...
          {FAQS.map((faq) => {
            ...
            return (
              <div key={faq.id} className="py-5 first:pt-0 last:pb-0">
                ...
                >
                  <span className="text-xs sm:text-sm font-sans font-medium text-[#f4f1ea]/80 group-hover/faq:text-[#f4f1ea] tracking-wide transition-colors">
                    {faq.question}
                  </span>
      ...
      {/* ============ ⑬ FOOTER ============ */}
      <footer className="bg-[#0b0b0a] text-[#f4f1ea] pt-16 sm:pt-24 pb-12 px-6 sm:px-12 border-t border-[#f4f1ea]/10">
      <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-10 border-t border-[#f4f1ea]/10 text-[#c4b9aa]/30">
