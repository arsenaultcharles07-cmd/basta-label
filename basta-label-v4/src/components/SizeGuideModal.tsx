      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-[#0d0d0b]/40 backdrop-blur-sm"
          />
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[#f4f1ea] border border-[#ccc9c1] text-[#0d0d0b] p-6 md:p-8 shadow-2xl overflow-y-auto max-h-[90vh] z-10"
          >
            {/* Close */}
            <button
              onClick={onClose}
              className="absolute top-6 right-6 p-1 text-[#2b2b27] hover:text-[#0d0d0b] transition-colors"
            ...
            <div className="mb-6">
              ...
              <h3 className="font-serif text-2xl font-light text-[#0d0d0b] tracking-wide flex items-center gap-3">
                <Ruler className="w-5 h-5 text-[#888580]" />
            ...
            {isTrouser ? (
              <div>
                <p className="text-xs text-[#888580] leading-relaxed mb-6">
                ...
                {/* Sizing Table */}
                <div className="overflow-x-auto border-t border-b border-[#ccc9c1]/50 py-2 mb-6">
                  <table className="w-full text-left text-xs text-[#2b2b27]">
                    <thead>
                      <tr className="border-b border-[#ccc9c1]/30 font-medium text-[#888580] uppercase tracking-wider">
                    ...
                    <tbody className="divide-y divide-[#ccc9c1]/20 font-sans">
                      <tr>
                        <td className="py-3 font-semibold text-[#0d0d0b]">XS</td>
                        <td className="py-3">72 - 76</td>
                        <td className="py-3">94 - 98</td>
                        <td className="py-3">79</td>
                        <td className="py-3">25.5</td>
                      </tr>
                      <tr className="bg-[#ede9df]/30">
                        <td className="py-3 font-semibold text-[#0d0d0b]">S</td>
                      ...
                      <tr>
                        <td className="py-3 font-semibold text-[#0d0d0b] font-medium text-black">M (Standard)</td>
                      ...
                      <tr className="bg-[#ede9df]/30">
                        <td className="py-3 font-semibold text-[#0d0d0b]">L</td>
                      ...
                      <tr>
                        <td className="py-3 font-semibold text-[#0d0d0b]">XL</td>
            ...
            {/* Measurement Tips */}
            <div className="bg-[#ede9df] p-4 border-l-2 border-[#888580] mb-6">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0d0d0b] flex items-center gap-1.5 mb-1.5">
                <Info className="w-3.5 h-3.5" />
                Conseil de notre styliste (Fit Counsel)
              </h4>
              <p className="text-[0.7rem] text-[#2b2b27] leading-relaxed">
                {isTrouser 
            ...
            {/* Packaging Narrative */}
            <div className="text-center font-serif italic text-xs text-[#888580] py-1 border-t border-[#ccc9c1]/30">
