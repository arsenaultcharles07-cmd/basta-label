      ...
      {isOpen && (
        <div className="fixed inset-0 z-[2000] overflow-hidden">
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-[#232323]/40 backdrop-blur-xs transition-opacity"
          />
          ...
          <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
            <motion.div
              ...
              className="w-screen max-w-md bg-[#f0ece3] border-l border-[#E5DED2]/50/60 flex flex-col shadow-2xl text-[#232323] relative"
            >
              {/* Header */}
              <div className="p-6 border-b border-[#E5DED2]/50/40 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <ShoppingBag className="w-4 h-4 text-[#A39382]" />
                  <h3 className="font-serif text-lg tracking-wide uppercase font-light text-[#232323]">
                    Mon Panier ({cartItems.reduce((acc, item) => acc + item.quantity, 0)})
                  </h3>
                </div>
                <button
                  onClick={onClose}
                  className="p-1 px-2.5 -mr-2 text-[#A39382] hover:text-[#232323] transition-colors flex items-center gap-1.5"
                >
              ...
              {checkedOutSuccess ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-[#E5DED2]/20/40">
                  ...
                  <h4 className="font-serif text-2xl font-light text-[#232323] leading-tight mb-3">
                    Votre commande est réservée.
                  </h4>
                  <p className="text-[0.72rem] text-[#A39382] max-w-xs leading-relaxed mb-6">
                  ...
                  <p className="text-[0.65rem] text-[#232323] font-mono mb-8 bg-[#f0ece3] p-3 px-4 border border-[#E5DED2]/50/40 rounded-sm">
                  ...
                  <button
                    ...
                    className="w-full max-w-xs py-3.5 bg-[#232323] text-[#FBF7F4] text-[0.6rem] font-sans font-light tracking-[0.2em] uppercase hover:bg-[#574e46] transition-all"
                  >
                    Retourner au Hub
                  </button>
                </div>
                ...
                <>
                  ...
                  <div className="flex-grow overflow-y-auto p-6 focus:outline-none">
                    {cartItems.length === 0 ? (
                      <div className="h-full flex flex-col items-center justify-center text-center opacity-80 py-12">
                        ...
                        <p className="font-serif italic text-base text-[#A39382] mb-2">
                          Votre panier est silencieux.
                        </p>
                        <p className="text-[0.68rem] text-[#A39382] max-w-[240px] leading-relaxed mb-6">
                          Prenez le temps d'explorer la Capsule 01 et de sélectionner des silhouettes faites pour durer.
                        </p>
                        <button
                          onClick={onClose}
                          className="px-6 py-2.5 bg-[#232323] text-[#FBF7F4] text-[0.55rem] uppercase tracking-widest font-light hover:bg-[#574e46] transition-all"
                        >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-[#E5DED2]/20 p-4.5 border border-[#E5DED2]/50/35 rounded-sm">
                          <div className="flex items-center gap-2 mb-2 text-[#232323]">
                            <Truck className="w-3.5 h-3.5 text-[#A39382]" />
                        ...
                        <div className="divide-y divide-[#ccc9c1]/30">
                          {cartItems.map((item) => (
                            <div key={item.id} className="py-4 first:pt-0 last:pb-0 flex gap-4">
                              ...
                              <div className="w-20 h-26 bg-[#E5DED2]/20 border border-[#E5DED2]/50/30 overflow-hidden flex-shrink-0 relative">
                                <img
                              ...
                              <div className="flex-1 flex flex-col justify-between">
                                <div>
                                  <div className="flex justify-between items-start">
                                    <h4 className="font-serif text-sm font-medium text-[#232323]">
                                      {item.product.name}
                                    </h4>
                                    <button
                                      onClick={() => onRemoveItem(item.id)}
                                      className="text-[0.55rem] uppercase tracking-wider text-[#A39382] hover:text-[#232323] transition-colors pl-2"
                                    >
                                      Enlever
                                    </button>
                                  </div>
                                  <p className="text-[0.62rem] text-[#A39382] tracking-wide uppercase mt-0.5">
                                ...
                                <div className="flex justify-between items-center mt-3">
                                  {/* Quantity adjusters */}
                                  <div className="flex items-center border border-[#E5DED2]/50 rounded-sm bg-[#f0ece3] px-1">
                                    <button
                                      onClick={() => onUpdateQuantity(item.id, -1)}
                                      className="p-1 px-1.5 text-[#A39382] hover:text-[#232323] transition-colors"
                                    >
                                  ...
                                  {/* Item Subtotal */}
                                  <span className="text-xs font-sans text-[#232323] tracking-wider">
                  ...
                  {/* Cart Footer Panel */}
                  {cartItems.length > 0 && (
                    <div className="p-6 border-t border-[#E5DED2]/50/50 bg-[#E5DED2]/20/50 space-y-4">
                      {/* Subtotal */}
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-xs font-sans text-[#ccc9c1] tracking-wider uppercase font-light">
                          <span>Livraison estimée</span>
                          <span className="text-[#232323] font-normal">
                            {isFreeShipping ? "Gratuite / Free" : "$15.00 CAD"}
                          </span>
                        </div>
                        <div className="flex justify-between text-base font-serif text-[#232323] tracking-wide pt-1 border-t border-[#E5DED2]/50/20">
                      ...
                      {/* Editorial prompt */}
                      <p className="text-[0.58rem] text-[#A39382] leading-relaxed text-center italic">
                      ...
                      <div className="pt-2">
                        <button
                          ...
                          className="w-full py-4 bg-[#232323] text-[#FBF7F4] text-[0.62rem] font-sans font-light tracking-[0.25em] uppercase hover:bg-[#574e46] transition-all disabled:opacity-75 relative flex items-center justify-center overflow-hidden"
                        >
                          {isCheckingOut ? (
                      ...
                      {/* Secure guidelines */}
                      <div className="flex justify-center items-center gap-4 pt-1.5 text-[#A39382]">
