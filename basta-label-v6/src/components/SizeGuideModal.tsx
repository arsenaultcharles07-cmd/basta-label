      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[#C8BDB1] border border-[#968473]/30 text-[#1a1614] p-6 md:p-8 shadow-2xl overflow-y-auto max-h-[90vh] z-10"
          >
            {/* Close */}
            <button
              onClick={onClose}
              className="absolute top-6 right-6 p-1 text-[#C8BDB1] hover:text-[#1a1614] transition-colors"
            ...
            <div className="mb-6">
              ...
              <h3 className="font-serif text-2xl font-light text-[#1a1614] tracking-wide flex items-center gap-3">
                <Ruler className="w-5 h-5 text-[#A89982]" />
            ...
            {isTrouser ? (
              <div>
                <p className="text-xs text-[#A89982] leading-relaxed mb-6">
                ...
                {/* Sizing Table */}
                <div className="overflow-x-auto border-t border-b border-[#968473]/30/50 py-2 mb-6">
                  <table className="w-full text-left text-xs text-[#C8BDB1]">
                    <thead>
                      <tr className="border-b border-[#968473]/30/30 font-medium text-[#A89982] uppercase tracking-wider">
                    ...
                    <tbody className="divide-y divide-[#ccc9c1]/20 font-sans">
                      <tr>
                        <td className="py-3 font-semibold text-[#1a1614]">XS</td>
                        <td className="py-3">72 - 76</td>
                        <td className="py-3">94 - 98</td>
                        <td className="py-3">79</td>
                        <td className="py-3">25.5</td>
                      </tr>
                      <tr className="bg-[#60544D]/30/30">
                        <td className="py-3 font-semibold text-[#1a1614]">S</td>
                      ...
                      <tr>
                        <td className="py-3 font-semibold text-[#1a1614] font-medium text-black">M (Standard)</td>
                      ...
                      <tr className="bg-[#60544D]/30/30">
                        <td className="py-3 font-semibold text-[#1a1614]">L</td>
                      ...
                      <tr>
                        <td className="py-3 font-semibold text-[#1a1614]">XL</td>
            ...
            {/* Measurement Tips */}
            <div className="bg-[#60544D]/30 p-4 border-l-2 border-[#888580] mb-6">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#1a1614] flex items-center gap-1.5 mb-1.5">
                <Info className="w-3.5 h-3.5" />
                Conseil de notre styliste (Fit Counsel)
              </h4>
              <p className="text-[0.7rem] text-[#C8BDB1] leading-relaxed">
                {isTrouser 
            ...
            {/* Packaging Narrative */}
            <div className="text-center font-serif italic text-xs text-[#A89982] py-1 border-t border-[#968473]/30/30">
