...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#5A493B] text-[#C8BDB1] font-sans selection:bg-[#1a1614]/10 selection:text-[#C8BDB1] overflow-x-hidden pb-12 sm:pb-20">
      {/* Dynamic Ambient Noise Texture layering overall screen depth */}
      <div className="grain-overlay" />
      
      {/* High-fidelity custom trailing cursor */}
      <CustomCursor />
      <div className="bg-[#1a1614] text-[#C8BDB1]/80 text-center py-2 px-4 text-[0.62rem] font-sans font-light tracking-[0.25em] uppercase">
        <span>Drop 01 &mdash; Disponible en tirage restreint. </span>
        <span className="text-[#C8BDB1] font-normal transition-all hover:text-[#C8BDB1] ml-1">
      ...
      <section className="relative h-[85vh] sm:h-[90vh] min-h-[600px] w-full flex items-end overflow-hidden bg-[#60544D]">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 sm:px-12 pb-12 sm:pb-20 z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            <span className="text-[0.62rem] font-sans font-medium tracking-[0.35em] text-[#C8BDB1]/60 uppercase block mb-3 animate-fadeIn">
              Capsule 01 &mdash; 2026
            </span>
            <h1 className="font-serif text-5xl sm:text-7xl lg:text-8xl font-light text-[#C8BDB1] leading-[0.95] tracking-tight">
              Basta.<br />
              <span className="font-serif italic text-[#C8BDB1]/75 font-normal tracking-wide text-[0.85em] lg:text-[0.82em]">
                to excess.
              </span>
            </h1>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end gap-6 sm:gap-8 md:text-right">
            <p className="text-[0.68rem] sm:text-xs font-sans font-light tracking-[0.2em] text-[#C8BDB1]/80 leading-relaxed uppercase max-w-sm">
              Quiet confidence.<br />
            ...
            <button
              ...
              className="group px-8 py-4 bg-[#5A493B] text-[#C8BDB1] text-[0.6rem] sm:text-[0.65rem] font-sans font-light tracking-[0.25em] uppercase hover:bg-[#3d3229] active:scale-98 transition-all flex items-center gap-3 shadow-md"
            >
      ...
      <div className="border-y border-[#C8BDB1]/10 bg-[#3d3229] py-3.5 overflow-hidden">
        <div className="flex whitespace-nowrap gap-12 w-max animate-infinite-scroll">
          ...
          {[1, 2].map((loopIdx) => (
            <div key={loopIdx} className="flex gap-12 items-center">
              <span className="text-[0.58rem] font-sans uppercase text-[#A89982] tracking-[0.22em] flex items-center gap-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div>
            <span className="text-[0.58rem] font-sans tracking-[0.25em] text-[#C8BDB1]/50 uppercase block mb-3">
              Garde-robe Sélectionnée
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#C8BDB1] leading-tight">
              The <span className="font-serif italic font-normal text-[#A89982]">Essential</span> Wardrobe.
            </h2>
          </div>
          <div>
            <span className="text-[0.62rem] font-sans font-light text-[#C8BDB1]/80 uppercase tracking-[0.2em] border-b border-[#C8BDB1]/15 pb-1 cursor-pointer hover:border-[#232323] transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {PRODUCTS.map((prod) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] w-full bg-[#3d3229] overflow-hidden mb-5">
                <img
                  src={prod.image}
                  alt={prod.name}
                  referrerPolicy="no-referrer"
                ...
                <div className="absolute inset-0 bg-[#1a1614]/2 opacity-0 group-hover:opacity-100 transition-opacity" />
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <button
                    ...
                    className="px-6 py-3 bg-[#1a1614] hover:bg-[#3d3229] text-[#C8BDB1] text-[0.58rem] font-sans tracking-[0.22em] uppercase transition-all shadow-xl font-light active:scale-95"
                  >
              ...
              <div className="flex justify-between items-start mt-1">
                <div>
                  <h3 className="font-serif text-md font-medium text-[#C8BDB1] tracking-wide">
                    {prod.name}
                  </h3>
                  <p className="text-[0.6rem] font-sans uppercase tracking-[0.15em] text-[#A89982] mt-1 flex items-center gap-2">
                    <span 
                      className="w-2.5 h-2.5 rounded-full border border-[#C8BDB1]/15"
                ...
                <div className="text-right">
                  <span className="text-xs font-sans text-[#C8BDB1] tracking-wider font-medium">
      ...
      {/* ============ ⑥ SECTION MANIFESTE ============ */}
      <section id="philosophy" className="bg-[#1a1614] text-[#C8BDB1] py-16 sm:py-28 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Block */}
          <div className="border-r border-[#C8BDB1]/10 pr-0 lg:pr-12 md:py-6">
            <span className="text-[0.55rem] font-sans tracking-[0.3em] text-[#A89982] uppercase block mb-6">
              La Philosophie Basta Label
            </span>
            <blockquote className="font-serif text-3xl sm:text-5xl lg:text-6xl font-light leading-[1.08] tracking-tight text-[#C8BDB1]">
              "Silence is the<br />
              highest form of<br />
              <span className="font-serif italic text-[#A89982]">presence & power.</span>"
            </blockquote>
          </div>

          {/* Right Block */}
          <div className="space-y-8 lg:pl-4">
            <p className="text-[0.72rem] sm:text-xs font-sans font-light tracking-[0.08em] text-[#A89982] leading-[2.1] max-w-lg">
            ...
            <div className="pt-2 flex items-center gap-6">
              <button
                ...
                className="px-6 py-3 border border-[#C8BDB1]/12 text-[#C8BDB1] text-[0.58rem] font-sans font-light tracking-[0.2em] uppercase hover:bg-[#3d3229]/5 hover:border-[#f4f1ea] transition-all"
              >
      ...
      {/* ============ ⑦ MAIN MATIÈRE (FABRIC) ============ */}
      <section id="fabric" className="bg-[#3d3229] py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Text block */}
          <div className="lg:col-span-5 space-y-6">
            <span className="text-[0.55rem] font-sans tracking-[0.22em] text-[#C8BDB1]/80 uppercase block mb-1">
              Origine de Tissage
            </span>
            <h3 className="font-serif text-3xl sm:text-4xl font-light text-[#C8BDB1] leading-tight">
              Un textile qui méritait d'exister. <br />
              <span className="font-serif italic text-[#A89982] font-normal">Structure & Souffle.</span>
            </h3>

            <p className="text-[0.72rem] sm:text-xs font-sans font-light text-[#C8BDB1]/80 leading-[2.1] tracking-wide">
            ...
            {/* Micro-specs grid */}
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-[#C8BDB1]/12">
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#A89982] mb-0.5">
                  Composition
                </span>
                <span className="text-xs font-serif italic text-[#C8BDB1]">80% Cotton · 20% Organic Lin</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#A89982] mb-0.5">
                  Densité de Fibre
                </span>
                <span className="text-xs font-sans font-medium text-[#C8BDB1]">300 GSM Heavyweight</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#A89982] mb-0.5">
                  Drap / Tombé
                </span>
                <span className="text-xs font-serif italic text-[#C8BDB1]">Rigide Structuré Flou</span>
              </div>
              <div>
                <span className="block text-[0.52rem] font-sans uppercase tracking-widest text-[#A89982] mb-0.5">
                  Certifications
                </span>
                <span className="text-xs font-sans font-medium text-[#C8BDB1]">GOTS Bio certifié</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-12 gap-4 relative">
            <div className="col-span-8 aspect-[4/5] bg-[#c4b9aa]/40 overflow-hidden shadow-sm relative">
              ...
              />
              <div className="absolute bottom-4 left-4 bg-[#5A493B] px-3.5 py-1 text-[0.52rem] font-sans tracking-widest uppercase font-mono text-[#C8BDB1]">
                Macro Tissage 300GSM
              </div>
            </div>
            
            <div className="col-span-4 aspect-[3/4] self-end bg-[#3d3229] overflow-hidden shadow-md hidden sm:block relative">
              {/* Secondary fabric angle / contrast */}
              <div className="absolute inset-0 bg-[#1a1614]/40 mix-blend-overlay z-10" />
              <img
              ...
              />
              <div className="absolute top-4 left-4 bg-[#1a1614] px-3 py-1 text-[0.45rem] tracking-[0.2em] uppercase font-sans text-[#C8BDB1]">
                Fibre Teinte
              </div>
            </div>
          </div>
      ...
      <section 
        ...
        className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24 border-t border-[#C8BDB1]/12 scroll-mt-24"
      >
      {/* Outer Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-start">
          {/* Column 1: Image Showcase */}
          <div className="lg:col-span-7 space-y-4">
            <span className="text-[0.55rem] font-sans tracking-[0.2em] text-[#A89982] uppercase block">
              Explorateur Visual-Hub (Angle {activePhotoIndex + 1}/2)
            </span>
            
            {/* Main Picture box with custom loader preview */}
            <div className="aspect-[3/4] w-full bg-[#3d3229] overflow-hidden rounded-xs relative group/detail">
              <img
              ...
              />
              <div className="absolute top-4 right-4 bg-[#1a1614]/30 backdrop-blur-md px-2.5 py-1 text-[0.55rem] font-mono text-[#C8BDB1] rounded-full uppercase tracking-widest flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 gap-4">
              {selectedProduct.secondaryImages.map((src, idx) => (
                <button
                  ...
                  className={`aspect-[4/3] bg-[#3d3229] overflow-hidden border transition-all ${
                    activePhotoIndex === idx
                      ? "border-[#232323] scale-[0.98] opacity-100 shadow-sm"
                      : "border-[#C8BDB1]/10 opacity-70 hover:opacity-100"
                  }`}
                >
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <div>
              <span className="text-[0.6rem] font-sans font-medium tracking-[0.25em] text-[#A89982] uppercase block mb-2">
                Basta Label &middot; Drop 01 Essentials
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-light text-[#C8BDB1] tracking-wide leading-tight">
                {selectedProduct.name} &mdash; <span className="font-serif italic font-normal text-[#A89982]">{selectedProduct.variantName}</span>
              </h2>
              
              {/* Product Price Tag */}
              <div className="flex items-center gap-4 mt-4">
                <span className="text-xl font-sans text-[#C8BDB1] font-medium tracking-wide">
                  ${selectedProduct.price.toFixed(2)} CAD
                </span>

                <span className="px-2.5 py-0.5 border border-[#7d6e62]/20 bg-[#3d3229]/5 text-[#A89982] rounded-xs text-[0.55rem] font-sans font-medium tracking-widest uppercase">
                  Finitudes Limite
                </span>
              </div>
            </div>

            <p className="text-[0.72rem] sm:text-xs font-sans font-light text-[#C8BDB1]/80 leading-relaxed">
              {selectedProduct.description}
            </p>

            {/* Selection Color Swappable */}
            <div>
              <span className="text-[0.55rem] font-medium tracking-[0.18em] text-[#A89982] uppercase block mb-2.5">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 border flex items-center gap-2 text-[0.62rem] font-sans uppercase tracking-widest transition-all ${
                      selectedProduct.id === prod.id
                        ? "border-[#232323] bg-[#3d3229]"
                        : "border-[#C8BDB1]/10 hover:border-[#232323]"
                    }`}
                  >
                    <span 
                      className="w-3 h-3 rounded-full border border-[#C8BDB1]/15"
                      style={{ backgroundColor: prod.variantColorCode }}
                    />
            ...
            <div>
              <div className="flex justify-between items-center mb-2.5">
                <span className="text-[0.55rem] font-medium tracking-[0.18em] text-[#A89982] uppercase">
                  Taille / Select Size
                </span>
                ...
                <button
                  ...
                  className="text-[0.55rem] font-sans font-light tracking-[0.15em] text-[#C8BDB1]/80 uppercase underline hover:opacity-75 flex items-center gap-1.5"
                >
                  <Ruler className="w-3.5 h-3.5 text-[#A89982]" />
                ...
                {selectedProduct.sizes.map((sz) => (
                  <button
                    ...
                    className={`w-11 h-11 text-xs border tracking-wider font-sans transition-all flex items-center justify-center ${
                      selectedSize === sz
                        ? "bg-[#1a1614] text-[#C8BDB1] border-[#232323] font-medium"
                        : "border-[#C8BDB1]/15 text-[#C8BDB1]/80 hover:border-[#232323] hover:text-[#C8BDB1]"
                    }`}
                  >
                    {sz}
                    {sz === "M" && (
                      <span className="absolute text-[0.38rem] translate-y-3.5 text-[#A89982] font-mono leading-none">Std</span>
                    )}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-3 pt-2">
              <button
                ...
                className="w-full py-4.5 bg-[#1a1614] hover:bg-[#3d3229] text-[#C8BDB1] text-[0.68rem] font-sans font-light tracking-[0.25em] uppercase transition-all shadow-md active:scale-99 flex items-center justify-center gap-2.5"
              >
              ...
              <button
                onClick={() => setSizeGuideOpen(true)}
                className="w-full py-4 border border-[#C8BDB1]/15 text-[#C8BDB1]/80 hover:border-[#232323] hover:text-[#C8BDB1] text-[0.62rem] font-sans font-light tracking-[0.22em] uppercase transition-all"
              >
            ...
            <div className="border-t border-[#C8BDB1]/12 pt-4 space-y-2">
              {/* Composition & Care */}
              <div className="border-b border-[#C8BDB1]/15/20 pb-2">
                <button
                  onClick={() => setActiveAccordion(activeAccordion === "comp" ? null : "comp")}
                  className="w-full flex justify-between items-center py-2 text-xs font-sans font-medium text-[#C8BDB1] tracking-wider uppercase"
                >
                  <span>Composition & Entretien / Care</span>
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "comp" ? "rotate-90 text-[#A89982]" : "text-[#A89982]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "comp" && (
                    <motion.div
                      ...
                      className="overflow-hidden text-[0.72rem] text-[#A89982] leading-[1.8] font-sans space-y-1.5 py-1"
                    >
              ...
              <div className="border-b border-[#C8BDB1]/15/20 pb-2">
                ...
                >
                  ...
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "fit" ? "rotate-90 text-[#A89982]" : "text-[#A89982]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "fit" && (
                    <motion.div
                      ...
                      animate={{ height: "auto", opacity: 1 }}
                      exit={{ height: 0, opacity: 0 }}
                      className="overflow-hidden text-[0.72rem] text-[#A89982] leading-[1.8] font-sans space-y-2 py-1"
                    >
                      ...
                      <p className="pt-2 text-[0.68rem] italic text-[#C8BDB1]/80">Coupe: {selectedProduct.fabricSpecs.fit}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
              ...
              <div className="border-b border-[#C8BDB1]/15/20 pb-2">
                ...
                >
                  ...
                  <span className={`text-[0.9rem] font-light transition-transform duration-300 ${activeAccordion === "ship" ? "rotate-90 text-[#A89982]" : "text-[#A89982]"}`}>
                    &middot;
                  </span>
                </button>
                <AnimatePresence initial={false}>
                  {activeAccordion === "ship" && (
                    <motion.div
                      ...
                      animate={{ height: "auto", opacity: 1 }}
                      exit={{ height: 0, opacity: 0 }}
                      className="overflow-hidden text-[0.72rem] text-[#A89982] leading-[1.8] font-sans py-1"
                    >
      ...
      <section className="bg-[#3d3229] border-y border-[#C8BDB1]/10 text-[#C8BDB1]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-[#ccc9c1]/10">
          {BRAND_VALUES.map((val) => (
            <div key={val.num} className="p-8 sm:p-12 space-y-4">
              <span className="font-serif text-3xl font-light text-[#A89982]/30 select-none block leading-none">
                {val.num}
              </span>
              <h4 className="font-serif italic text-base lg:text-lg text-[#C8BDB1] leading-tight">
                {val.title}
              </h4>
              <p className="text-[0.68rem] font-sans font-light text-[#A89982]/60 leading-[1.85] tracking-wide">
                {val.desc}
              </p>
            </div>
          ))}
      ...
      <div className="flex justify-between items-end mb-12">
          <div>
            <span className="text-[0.55rem] font-sans tracking-[0.25em] text-[#C8BDB1]/50 uppercase block mb-3">
              Cercle Basta Label
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-light text-[#C8BDB1] leading-[1.12]">
              The <span className="font-serif italic font-normal text-[#A89982]">quiet few.</span>
            </h2>
          </div>
          <div>
            <a 
              href="#instagram-link" 
              className="text-[0.62rem] font-sans uppercase tracking-[0.2em] font-medium text-[#C8BDB1] border-b border-[#232323] pb-0.5 hover:border-[#888580] hover:text-[#A89982] transition-colors"
            >
              @bastalabel
            </a>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {SOCIALS.map((soc) => (
            <div
              key={soc.id}
              className="group relative aspect-square bg-[#3d3229] overflow-hidden rounded-xs cursor-pointer"
            >
              ...
              <div className="absolute inset-x-2 bottom-2 top-10 bg-[#1a1614]/10 blur-xl rounded-full" />
              
              {/* Fine subtle overlay text framing human identity */}
              <div className="absolute inset-0 z-10 flex flex-col justify-between p-4 bg-black/0 group-hover:bg-[#1a1614]/65 transition-all duration-300">
                <div className="self-end text-[0.45rem] font-mono uppercase tracking-[0.2em] text-[#C8BDB1]/0 group-hover:text-[#C8BDB1]/40 transition-colors">
                  Verified Fit
                </div>
                <div>
              ...
              <div className="absolute top-4 right-4 w-1.5 h-1.5 rounded-full bg-[#C8BDB1]/20 select-none group-hover:bg-[#c4b89e] group-hover:scale-125 transition-all" />
              
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span className="font-serif italic text-3xl opacity-[0.06] text-[#C8BDB1] tracking-widest select-none">Basta.</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-[#1a1614] text-[#C8BDB1] py-20 sm:py-32 border-t border-[#C8BDB1]/10 text-center relative overflow-hidden">
      <div className="max-w-2xl mx-auto px-6 relative z-10">
          <span className="text-[0.52rem] font-sans tracking-[0.35em] text-[#A89982] uppercase block mb-4">
            Registre de Priorité &middot; Newsletter
          </span>
          <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-light text-[#C8BDB1] tracking-tight leading-none mb-3">
            Rejoins <span className="font-serif italic font-normal text-[#A89982]">les rares.</span>
          </h2>
          <p className="text-[0.68rem] sm:text-xs font-sans font-light tracking-[0.1em] text-[#A89982]/75 leading-relaxed max-w-md mx-auto mb-10 sm:mb-12">
          ...
          <AnimatePresence mode="wait">
            {!newsletterSubscribed ? (
              <motion.form 
                ...
                className="max-w-md mx-auto flex items-center border-b border-[#C8BDB1]/15 pb-2.5 focus-within:border-white transition-colors"
              >
                <input
                  type="email"
                  required
                ...
                <button
                  type="submit"
                  className="p-1 px-4 text-[0.55rem] sm:text-[0.6rem] font-sans uppercase tracking-[0.25em] text-[#C8BDB1] hover:text-[#C8BDB1] transition-colors shrink-0"
                >
                  S'enregistrer &rarr;
                </button>
              </motion.form>
      ...
      {/* Left Col */}
        <div className="lg:col-span-4">
          <span className="text-[0.55rem] font-sans tracking-[0.22em] text-[#C8BDB1]/50 uppercase block mb-3">
            Soutien à la décision
          </span>
          <h3 className="font-serif text-3xl sm:text-4xl font-light text-[#C8BDB1] leading-tight">
            Questions<br />
            <span className="font-serif italic font-normal text-[#A89982]">fréquentes.</span>
          </h3>
          <p className="text-[0.72rem] text-[#A89982] mt-4 leading-relaxed max-w-xs font-light">
            Une hésitation relative à la matière de coton-lin ou au drapé du pantalon ? Nos équipes de couturiers sont rattachées en continu via <span className="font-medium underline hover:text-[#C8BDB1] cursor-pointer">hello@bastalabel.com</span>
          </p>
        </div>
          ...
          {FAQS.map((faq) => {
            ...
            return (
              <div key={faq.id} className="py-5 first:pt-0 last:pb-0">
                ...
                >
                  <span className="text-xs sm:text-sm font-sans font-medium text-[#C8BDB1]/80 group-hover/faq:text-[#C8BDB1] tracking-wide transition-colors">
                    {faq.question}
                  </span>
                  <span className={`text-[1.2rem] font-light transition-transform duration-300 flex-shrink-0 ${isOpen ? "rotate-45 text-[#A89982]" : "text-[#A89982]"}`}>
                    +
                  </span>
                </button>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="text-[0.72rem] sm:text-[0.75rem] text-[#A89982] leading-[1.9] tracking-wide pt-4 pb-1 select-text">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
      ...
      {/* ============ ⑬ FOOTER ============ */}
      <footer className="bg-[#1a1614] text-[#C8BDB1] pt-16 sm:pt-24 pb-12 px-6 sm:px-12 border-t border-[#C8BDB1]/10">
      <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 sm:gap-8 items-start">
            <div className="lg:col-span-4 space-y-4">
              <div className="flex flex-col items-start select-none">
                ...
                <span className="logo-label text-[#A89982] block -mt-0.5">
                  LABEL
                </span>
              </div>
              <p className="text-[0.62rem] text-[#A89982]/50 leading-[1.95] tracking-[0.08em] uppercase max-w-sm">
                Quiet confidence.<br />
            ...
            <div className="lg:col-span-2.5 space-y-4">
              <h4 className="text-[0.55rem] font-sans tracking-[0.25em] text-[#A89982] uppercase">
                Acheter / Shop
              </h4>
              <ul className="space-y-2.5 list-none text-[0.65rem] tracking-wider text-[#A89982]/60 font-light uppercase">
                <li>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-10 border-t border-[#C8BDB1]/10 text-[#A89982]/30">
